...
X_train['TotalCharges'].fillna((X_test['TotalCharges'].mean()), inplace=True)
...
X_train[cat]= X_train[cat].apply(lambda col: le.fit_transform(col))
X_test[cat]= X_test[cat].apply(lambda col: le.fit_transform(col))
