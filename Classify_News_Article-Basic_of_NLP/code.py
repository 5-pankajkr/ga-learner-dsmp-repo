...
# y_p_count= nb_1.predict(X_test_count)
# y_p_tfidf= nb_2.predict(X_test_tfidf)

print("Y_test: ", Y_test.shape)

# accuracy with count vectorizer
# acc_count_nb= accuracy_score(y_p_count, Y_test)

# # accuracy with tfidf vectorizer
# acc_tfidf_nb= accuracy_score(y_p_tfidf, Y_test)
